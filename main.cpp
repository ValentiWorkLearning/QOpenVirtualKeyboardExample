...
int main(int argc, char* argv[])
{
    ...
    qputenv("QT_IM_MODULE", QByteArray("openvirtualkeyboard:animateRollout:immediateLoading"));
    ...
    QLoggingCategory::setFilterRules(
        QStringLiteral("qt.qml.binding.removal.info=true;openvirtualkeyboard=true"));
